...
input_path <- file.path(root, "output", "nhanes_albumin_benchmarks", "NHANES_albumin_benchmark_results.rds")
time_effect_path <- file.path(root, "output", "nhanes_corrected_bootstrap", "Table32E_time_varying_score_effects.csv")
time_test_path <- file.path(root, "output", "nhanes_corrected_bootstrap", "Table32F_time_varying_model_comparison.csv")
output_dir <- file.path(root, "output", "nhanes_nonlinearity_freeze_v2")
